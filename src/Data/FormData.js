    ...
    <View style={styles.geral}>
      <ScrollView ref={scrollView}>
          ...
          <>
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, participouOutro: selected }));
            ...
            {state === true && (
              <MultipleCheckBox
                ...
                value={values.casoParticipe}
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, casoParticipe: selected }));
                }}
              />
            )}
          </>
          ...
          <View>
            <View style={styles.box}>
              <Text style={styles.text}>
                Neste questionário o chefe da família considerado é a pessoa de
                maior renda
              </Text>

              <Text style={styles.text}>Quantidade de itens de conforto:</Text>
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_1: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_2: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_3: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_4: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_5: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_6: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_7: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_8: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_9: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_10: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_11: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ABEP_12: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ABEP_13: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ABEP_14: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ABEP_15: selected }));
        ...
        {page === 3 && (
          <View style={styles.box}>
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_1: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_2: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_3: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_4: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_5: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, MICS_6: selected }));
        ...
        {page === 4 && (
          <View style={styles.box}>
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_1: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_2: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_3: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_4: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_5: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_6: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_7: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_8: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_9: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_10: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_11: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_12: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_13: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_14: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_15: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_16: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_17: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PSOC_18: selected }));
        ...
        {page === 5 && (
          <View style={styles.box}>
            <Text>
              ...
              sua criança. Os números 1 e 2 indicam que o seu comportamento está
              mais próximo do enunciado da esquerda; o número 3 indica que está
              no meio; e os números 4 e 5 indicam que o seu comportamento está
              mais próximo do enunciado da direita
            </Text>
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP2}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP2: selected }));
              }}
            />
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP4}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP4: selected }));
              }}
            />
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP5}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP5: selected }));
              }}
            />
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP6}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP6: selected }));
              }}
            />
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP7}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP7: selected }));
              }}
            />
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP8}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP8: selected }));
              }}
            />
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP10}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP10: selected }));
              }}
            />
            ...
            <MultipleCheckBoxSingle
              ...
              value={values.ACT_EP11}
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_EP11: selected }));
              }}
            />
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP1: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP2: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP3: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP4: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP5: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP6: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, ACT_CP8: selected }));
        ...
        {page === 6 && (
          <View style={styles.box}>
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_1: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_2: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_3: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_4: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_5: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_6: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_7: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_8: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_9: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, PAFAS_11: selected }));
              }}
        ...
        {family.crianca.idade >= 2 && page === 7 ? (
          <View style={styles.box}>
            <Text>
              Selecione a alternativa que melhor descreva a CRIANÇA. Responda a
              todas as perguntas da melhor maneira possível, mesmo que você não
              tenha certeza absoluta ou se a pergunta lhe parecer estranha. Dê
              suas respostas com base no comportamento atual da criança.
            </Text>
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_1: selected }));
                //validateField("SDQ_1");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_2: selected }));
                //validateField("SDQ_2");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_3: selected }));
                //validateField("SDQ_3");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_4: selected }));
                //validateField("SDQ_4");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_5: selected }));
                //validateField("SDQ_5");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_6: selected }));
                //validateField("SDQ_6");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_7: selected }));
                //validateField("SDQ_7");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_8: selected }));
                //validateField("SDQ_8");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_9: selected }));
                //validateField("SDQ_9");
              }}
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_10: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_11: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_12: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_13: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_14: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_15: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_16: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_17: selected }));
            ...
            {family.crianca.idade <= 3 && family.crianca.idade >= 2 ? (
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_18(2-3)"]: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_18(4-8)"]: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_19: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_20: selected }));
            ...
            {family.crianca.idade >= 2 && family.crianca.idade <= 3 ? (
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_21(2-3)"]: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_21(4-8)"]: selected }));
            ...
            {family.crianca.idade >= 2 && family.crianca.idade <= 3 ? (
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_22(2-3)"]: selected }));
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ["SDQ_22(4-8)"]: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_23: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_24: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, SDQ_25: selected }));
        ...
        page === 8 ? (
          <View style={styles.box}>
            <Text style={styles.text}>
              Você está sendo convidado a pensar sobre o seu futuro. Para isso,
              pense na pessoa que você é hoje e imagine como você gostaria de
              estar no futuro. Para responder as afirmações abaixo, pense no que
              você quer que esteja acontecendo em sua vida daqui a 10 anos.
            </Text>
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_3: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_4: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_8: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_10: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_12: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_14: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_15: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_16: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_18: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_20: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_21: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_23: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_24: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_26: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_28: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_31: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_32: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_34: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_36: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_38: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_40: selected }));
            ...
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, EPVA_42: selected }));
        ...
        {family.formulariosPreenchidos === 1 && page === 9 ? (
          <View style={styles.box}>
            <Select
              ...
              onSelectionChange={(selected) => {
                setValues((prev) => ({ ...prev, VI_1: selected }));
                if (selected === "Sim") {
                  setState2(true);
                } else {
                  setState2(false);
            ...
            {state2 === true ? (
              <>
                <MultipleCheckBox
                  ...
                  value={values.VI_2}
                  onSelectionChange={(selected) => {
                    setValues((prev) => ({ ...prev, VI_2: selected }));
                    //validateField("VI_2");
                  }}
                />
                <MultipleCheckBox
                  ...
                  data={[
                    ...
                    {
                      id: 3,
                      key: "Negligência (ex: falta de alimentação e cuidados)",
                      checked: "unchecked",
                    },
                  ]}
                  style={styles.box1}
                  value={values.VI_3}
                  onSelectionChange={(selected) => {
                    setValues((prev) => ({ ...prev, VI_3: selected }));
                  }}
                />
                <MultipleCheckBox
                  value={values.VI_4}
                  ...
                  value={values.VI_4}
                  onSelectionChange={(selected) => {
                    setValues((prev) => ({ ...prev, VI_4: selected }));
          ...
          <>
            {(family.formulariosPreenchidos === 1 ||
              ...
              <Select
                ...
                onSelectionChange={(selected) => {
                  setValues((prev) => ({ ...prev, ACT: selected }));
                  ...
                  switch (page) {
                    ...
                    case 7: {
                      if (
                        ...
                        (family.crianca.idade <= 3 && family.crianca.idade >= 2
                          ? values["SDQ_18(2-3)"] === ""
                          : false) ||
                        (family.crianca.idade <= 8 && family.crianca.idade >= 4
                          ? values["SDQ_18(4-8)"] === ""
                          : false) ||
                        values.SDQ_19 === "" ||
                        values.SDQ_20 === "" ||
                    ...
                    case 10: {
                      if (values.ACT === "") setPageError(true);
                        ...
                        setPageError(false);
                        setValues((prev) => ({ ...prev, familia: family }));
                        array.forEach((item, index) => {
                          if (item === page) {
                            it = array[index + 1];
                          }
